...
<a role="button" href="{{route('tableadd',['auditoriumId' => $auditorium->id])}}"class="btn btn-light" style="font-weight:bold; color:white; background-color:#f350a4;width: 15%;height: 40px;"> + Add  </a>
<br>
<br>
