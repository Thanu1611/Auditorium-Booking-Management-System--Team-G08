      ...
      <div class="col">
        <div class="row row-cols-2 row-cols-sm-2 g-4">
          ...
          <a  href="{{route('audiupdate',['auditoriumId' =>$auditoriumId])}}" class="btn btn-primary " style="font-weight:bold;height: 40px; background-color:#573b8a;" >
            ...
            <h4 class="fw-semibold mb-0 text-body-emphasis" >Update Details</h4>
            <p class="text-body-secondary">allows you to modify and update the details of the auditorium.
             </p>
          </div>
         ...
         <div >
           ...
           <p class="text-body-secondary">list of upcoming events scheduled in the auditorium. </p>
         </div>
        </div>
      </div>
    </div>
