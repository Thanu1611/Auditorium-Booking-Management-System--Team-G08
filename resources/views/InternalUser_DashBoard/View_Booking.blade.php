...
<table class="table table-hover table-container">
    ...
    <tr class="hover-row" hover="color:white">
		...
		<div class="col-md-4">
			<td><a role="button" class="btn btn-light" style="font-weight:bold; color:white; background-color:#f350a4;width: 100%;height: 40px;" href="{{route('detail',['eventId' => $event->id])}}" >View</a></td>
            <td colspan=2><a role="button" class="btn btn-light" style="font-weight:bold; color:white; background-color:#f350a4;width: 100%;height: 40px;" href="{{route('changeAppStatus',['eventId' => $event->id])}}" > Cancel Booking</a></td>
		</div>			
