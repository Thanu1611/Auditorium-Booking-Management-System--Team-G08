...
<style>
  ...
  tbody {
    margin-top: 80px;
    /* Change this value to match the height of your thead */
  }
...
<body>
  <div class="layoutmain" style="display:flex; position:fixed; top:0; width:100%">
    <div class="col-md-6" style="display:flex">
      <img src="https://www.jfn.ac.lk/wp-content/uploads/uoj_logo.png" style="width:200px; height:60px" alt="hos_logo">
  ...
  <div class="container">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="https://www.jfn.ac.lk/wp-content/uploads/2017/02/Prof.s.Maheswaran-Memorial-Lecture-2017_34.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTYAP-x13nqeVFf_ZqSlbReG_oP6-Z5LDQtgQ&usqp=CAU" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="https://itum.mrt.ac.lk/sites/default/files/inline-images/1_0.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
