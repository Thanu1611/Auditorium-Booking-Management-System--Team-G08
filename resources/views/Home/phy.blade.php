...
<div >
  <div  class="carousel slide carousel-fade" data-bs-ride="carousel">
    <div class="carousel-indicators">
      ...
      <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="2"></button>
        ...
        <div class="carousel-inner">
          ...
          <img src="/images/P2.jpg" class="d-block w-100" alt="..." height="600">
          </div>
          <div class="carousel-item" data-bs-interval="2000">
          <img src="/images/p3.jpg" class="d-block w-100" alt="..." height="600">
          </div>
          <div class="carousel-item active" data-bs-interval="2000">
          <img src="/images/p4.jpg" class="d-block w-100" alt="..." height="600">
          </div>
    ...
    <br>
    <h5>
    <p style="margin-bottom: 5px;"> &#x2714; This auditorium has a seating capacity of 40.<br></p>
