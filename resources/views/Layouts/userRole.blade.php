        ...
        <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            <li>
              <a href="{{ route('addbook')}}" class="nav-link text-black">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#user_add_book"/></svg>
                Add booking
              </a>
            </li>
            <li>
              <a href="{{ route('view_book')}}" class="nav-link text-black">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#user_view_book"/></svg>
                View Booking
              </a>
            </li>
            <li>
